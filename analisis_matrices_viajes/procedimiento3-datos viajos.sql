USE [Base]
GO
/****** Object:  StoredProcedure [dbo].[_003_2_Estadisticas_Corredor]    Script Date: 26/3/2025 12:44:40 ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
ALTER PROCEDURE [dbo].[_003_2_Estadisticas_Corredor]
...
BEGIN
 BEGIN TRY
	...
	DECLARE @sql NVARCHAR(MAX);
		...
		GROUP BY
			v.ParOD, v.distancia, v.IdO, v.IdD,v.h3_o, v.h3_d, v.z_origen,v.z_destino
		ORDER BY
			v.ParOD;';
		print @SQL;
