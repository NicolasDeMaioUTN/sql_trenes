...
BEGIN
 ...
 BEGIN TRANSACTION;
		...
		-- 7. Calculo distribuci�n de viajes por ModoMultimodal y Combinacion | _2_2_distribucion_MultiModal_ModoCombinacion_tc_0
		SET @sql =
		...
		-- 8. Calculo distribuci�n de viajes por Distancia y ModoMultimodal | _2_2_distribucion_distancia_MultiModal_tc_0
		SET @sql =
		...
		-- 9. Calculo distribuci�n de viajes por ModoMultimodal, Combinacion y horario | _2_2_distribucion_distancia_ModoMultiModal_Combinacion_horario_tc_0
		SET @sql =
		...
		-- 11. Calculo de distribuci�n de viajes por Horario y distancia | _2_2_distribucion_horario_distancia_tc_0
		SET @sql =
		...
		-- 12. Calculo de distribuci�n de viajes por horario y modo de combinacion | _2_2_distribucion_horario_ModoCombinacion_tc_0
		SET @sql =
		...
		SELECT 
			...
			PARTITIONED8.NombreCombinacion_Part8 AS Etapa8,
			PARTITIONED9.NombreCombinacion_Part9 AS Etapa9
		INTO '+QUOTENAME(@Database)+'.dbo._2_2_1_combinacion_utilizadas_ParOD_Modo_tc_0 -- Lineas M�s Utilizadas ParOD y Modo
		FROM (
			SELECT 
				ParOD, z_origen, z_destino, NombreCombinacion, distancia, CantidadRepeticiones, ModoMultimodal,
				SUM(SumaViajes) AS SumaViajes, 
		...
		SET @sql =
			...
			SELECT 
				...
				PARTITIONED8.NombreCombinacion_Part8 AS Etapa8,
				PARTITIONED9.NombreCombinacion_Part9 AS Etapa9
			INTO '+QUOTENAME(@Database)+'.dbo._2_2_1_combinacion_utilizadas_ParOD_Horario_tc_0 -- Lineas M�s Utilizadas ParOD y Modo
			FROM (
				SELECT 
					ParOD, z_origen, z_destino,NombreCombinacion, distancia, pico_horario, CantidadRepeticiones,
					SUM(SumaViajes) AS SumaViajes, -- Primero calculo la suma de etapas por par OD
		...
		SET @sql =
			...
			SELECT 
				...
				PARTITIONED8.NombreCombinacion_Part8 AS Etapa8,
				PARTITIONED9.NombreCombinacion_Part9 AS Etapa9
			INTO '+QUOTENAME(@Database)+'.dbo._2_2_1_combinacion_utilizadas_ParOD_Modo_Distancia_tc_0 -- Lineas M�s Utilizadas ParOD y Modo
			FROM (
				SELECT 
					ParOD, z_origen, z_destino, NombreCombinacion,distancia, ModoMultimodal, CantidadRepeticiones,
					SUM(SumaViajes) AS SumaViajes, -- Primero calculo la suma de etapas por par OD
		...
		SET @sql =
			...
			SELECT 
				...
				PARTITIONED8.NombreCombinacion_Part8 AS Etapa8,
				PARTITIONED9.NombreCombinacion_Part9 AS Etapa9
			INTO '+QUOTENAME(@Database)+'.dbo._2_2_1_combinacion_utilizadas_ParOD_Modo_Distancia_horario_tc_0 -- Lineas M�s Utilizadas ParOD y Modo
			FROM (
				SELECT 
					ParOD, z_origen, z_destino,NombreCombinacion, distancia, ModoMultimodal, pico_horario, CantidadRepeticiones,
					SUM(SumaViajes) AS SumaViajes, -- Primero calculo la suma de etapas por par OD
		...
		SET @sql =
			...
			SELECT 
				...
				PARTITIONED8.NombreCombinacion_Part8 AS Etapa8,
				PARTITIONED9.NombreCombinacion_Part9 AS Etapa9
			INTO '+QUOTENAME(@Database)+'.dbo._2_2_1_combinacion_utilizadas_ModoMultimodal_tc_0 -- Lineas M�s Utilizadas ParOD y Modo
			FROM (
				SELECT 
					ModoMultimodal,NombreCombinacion,
					SUM(CantidadRepeticiones) AS CantidadRepeticiones,
		...
		SELECT 
			...
			PARTITIONED8.NombreCombinacion_Part8 AS Etapa8,
			PARTITIONED9.NombreCombinacion_Part9 AS Etapa9
		INTO '+QUOTENAME(@Database)+'.dbo._2_2_1_combinacion_utilizadas_horario_tc_0 -- Lineas M�s Utilizadas ParOD y Modo
		FROM (
			SELECT 
				pico_horario,NombreCombinacion,
				SUM(CantidadRepeticiones) AS CantidadRepeticiones,
		...
		SELECT 
			...
			PARTITIONED8.NombreCombinacion_Part8 AS Etapa8,
			PARTITIONED9.NombreCombinacion_Part9 AS Etapa9
		INTO '+QUOTENAME(@Database)+'.dbo._2_2_1_combinacion_utilizadas_Distancia_Modo_tc_0 -- Lineas M�s Utilizadas ParOD y Modo
		FROM (
			SELECT 
				Distancia, ModoMultimodal,NombreCombinacion,
				SUM(CantidadRepeticiones) AS CantidadRepeticiones,
		...
		SET @sql =
			...
			SELECT 
				...
				PARTITIONED8.NombreCombinacion_Part8 AS Etapa8,
				PARTITIONED9.NombreCombinacion_Part9 AS Etapa9
			INTO '+QUOTENAME(@Database)+'.dbo._2_2_1_combinacion_utilizadas_Distancia_Modo_Horario_tc_0 -- Lineas M�s Utilizadas ParOD y Modo
			FROM (
				SELECT 
					Distancia,pico_horario, ModoMultimodal,NombreCombinacion,
					SUM(CantidadRepeticiones) AS CantidadRepeticiones,
 ...
 BEGIN TRANSACTION;
		...
		SET @sql =
			...
			SELECT 
				...
				PARTITIONED8.NombreCombinacion_Part8 AS Etapa8,
				PARTITIONED9.NombreCombinacion_Part9 AS Etapa9
			INTO '+QUOTENAME(@Database)+'.dbo._2_2_1_combinacion_utilizadas_ParOD_Horario_tc_1 -- Lineas M�s Utilizadas ParOD y Modo
			FROM (
				SELECT 
					ParOD, z_origen, z_destino,NombreCombinacion, distancia, pico_horario, CantidadRepeticiones,
					SUM(SumaViajes) AS SumaViajes, -- Primero calculo la suma de etapas por par OD
		...
		SET @sql =
			...
			SELECT 
				...
				PARTITIONED8.NombreCombinacion_Part8 AS Etapa8,
				PARTITIONED9.NombreCombinacion_Part9 AS Etapa9
			INTO '+QUOTENAME(@Database)+'.dbo._2_2_1_combinacion_utilizadas_ParOD_Modo_Distancia_tc_1 -- Lineas M�s Utilizadas ParOD y Modo
			FROM (
				SELECT 
					ParOD, z_origen, z_destino, NombreCombinacion,distancia, ModoMultimodal, CantidadRepeticiones,
					SUM(SumaViajes) AS SumaViajes, -- Primero calculo la suma de etapas por par OD
