USE [Base]
GO
/****** Object:  StoredProcedure [dbo].[_006_1_Viajes_Propios_Grupo_Lineas]    Script Date: 26/3/2025 12:46:43 ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
ALTER PROCEDURE [dbo].[_006_1_Viajes_Propios_Grupo_Lineas]
 ...
 BEGIN TRY
	BEGIN TRANSACTION;
		...
		SET @sql = 
			...
			GROUP BY v.IdO, v.IdD, v.distance_h3, v.distance_osm_drive, v.id_tarjeta, v.id_viaje,
			v.hora, o.zonas, d.zonas, v.factor_expansion_linea, v.tren, v.autobus, v.metro, v.cant_etapas;';
		PRINT @sql;
